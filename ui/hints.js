...
const KANJI_EXTRA_TEXT = new Map([
            ['日', [
                ...
                'All kanji are made of radicals, which have their own meanings, and some even have multiple forms. Most kanji have multiple radicals, but some simple ones only have one.'
            ]],
            ...
            ['百', [
                `The 百 character is the first example of the most common
            ...
            [ '三', 'The 一 radical of 三 kanji means "one".' ],
            [ '中', 'The 丨 radical of 中 kanji means "line".' ],
            [ '丸', 'The 丶 radical of 丸 kanji means "dot".' ],
            [ '乗', 'The 丿 (乀) radical of 乗 kanji means "slash".' ],
            [ '九', 'The 乙 (乚、乛、⺄) radical of 九 kanji means "second".' ],
            [ '事', 'The 亅 radical of 事 kanji means "hook".' ],
            [ '五', 'The 二 radical of 五 kanji means "two".' ],
            [ '京', 'The 亠 radical of 京 kanji means "lid".' ],
            [ '休', 'The 人 (亻、𠆢) radical of 休 kanji means "man".' ],
            [ '先', 'The 儿 radical of 先 kanji means "son, legs".' ],
            [ '全', 'The 入 radical of 全 kanji means "enter".' ],
            [ '六', 'The 八 (丷) radical of 六 kanji means "eight".' ],
            [ '円', 'The 冂 radical of 円 kanji means "wide".' ],
            [ '写', 'The 冖 radical of 写 kanji means "cloth cover".' ],
            [ '冬', 'The 冫 radical of 冬 kanji means "ice".' ],
            [ '処', 'The 几 radical of 処 kanji means "table".' ],
            [ '出', 'The 凵 radical of 出 kanji means "receptacle".' ],
            [ '分', 'The 刀 (刂、⺈) radical of 分 kanji means "knife".' ],
            [ '動', 'The 力 radical of 動 kanji means "power".' ],
            [ '包', 'The 勹 radical of 包 kanji means "wrap".' ],
            [ '北', 'The 匕 radical of 北 kanji means "spoon".' ],
            [ '匠', 'The 匚 radical of 匠 kanji means "box".' ],
            [ '区', 'The 匸 radical of 区 kanji means "hiding enclosure".' ],
            [ '千', 'The 十 radical of 千 kanji means "ten".' ],
            [ '占', 'The 卜 radical of 占 kanji means "divination".' ],
            [ '印', 'The 卩 (㔾) radical of 印 kanji means "seal (device)".' ],
            [ '原', 'The 厂 radical of 原 kanji means "cliff".' ],
            [ '去', 'The 厶 radical of 去 kanji means "private".' ],
            [ '友', 'The 又 radical of 友 kanji means "again".' ],
            [ '名', 'The 口 radical of 名 kanji means "mouth".' ],
            [ '四', 'The 囗 radical of 四 kanji means "enclosure".' ],
            [ '地', 'The 土 radical of 地 kanji means "earth".' ],
            [ '売', 'The 士 radical of 売 kanji means "scholar".' ],
            [ '変', 'The 夂 radical of 変 kanji means "go".' ],
            [ '夏', 'The 夊 radical of 夏 kanji means "go slowly".' ],
            [ '外', 'The 夕 radical of 外 kanji means "evening".' ],
            [ '天', 'The 大 radical of 天 kanji means "big".' ],
            [ '妹', 'The 女 radical of 妹 kanji means "woman".' ],
            [ '学', 'The 子 radical of 学 kanji means "child".' ],
            [ '家', 'The 宀 radical of 家 kanji means "roof".' ],
            [ '寺', 'The 寸 radical of 寺 kanji means "inch".' ],
            [ '少', 'The 小 (⺌、⺍) radical of 少 kanji means "small".' ],
            [ '就', 'The 尢 (尣) radical of 就 kanji means "lame".' ],
            [ '局', 'The 尸 radical of 局 kanji means "corpse".' ],
            [ '屯', 'The 屮 radical of 屯 kanji means "sprout".' ],
            [ '岩', 'The 山 radical of 岩 kanji means "mountain".' ],
            [ '州', 'The 巛 (川) radical of 州 kanji means "river".' ],
            [ '左', 'The 工 radical of 左 kanji means "work".' ],
            [ '巻', 'The 己 radical of 巻 kanji means "oneself".' ],
            [ '市', 'The 巾 radical of 市 kanji means "turban".' ],
            [ '年', 'The 干 radical of 年 kanji means "dry".' ],
            [ '幼', 'The 幺 (么) radical of 幼 kanji means "short thread".' ],
            [ '広', 'The 广 radical of 広 kanji means "dotted cliff".' ],
            [ '建', 'The 廴 radical of 建 kanji means "long stride".' ],
            [ '弁', 'The 廾 radical of 弁 kanji means "arch".' ],
            [ '式', 'The 弋 radical of 式 kanji means "shoot".' ],
            [ '強', 'The 弓 radical of 強 kanji means "bow".' ],
            [ '当', 'The 彐 (彑) radical of 当 kanji means "snout".' ],
            [ '形', 'The 彡 radical of 形 kanji means "bristle".' ],
            [ '後', 'The 彳 radical of 後 kanji means "step".' ],
            [ '思', 'The 心 (忄、⺗) radical of 思 kanji means "heart".' ],
            [ '戦', 'The 戈 radical of 戦 kanji means "halberd".' ],
            [ '所', 'The 戶 (户、戸) radical of 所 kanji means "door".' ],
            [ '才', 'The 手 (扌、龵) radical of 才 kanji means "hand".' ],
            [ '支', 'The 支 radical of 支 kanji means "branch".' ],
            [ '数', 'The 攴 (攵) radical of 数 kanji means "rap, tap".' ],
            [ '斎', 'The 文 radical of 斎 kanji means "script".' ],
            [ '料', 'The 斗 radical of 料 kanji means "dipper".' ],
            [ '新', 'The 斤 radical of 新 kanji means "axe".' ],
            [ '族', 'The 方 radical of 族 kanji means "square".' ],
            [ '既', 'The 无 (旡) radical of 既 kanji means "not".' ],
            [ '早', 'The 日 radical of 早 kanji means "sun".' ],
            [ '書', 'The 曰 radical of 書 kanji means "say".' ],
            [ '朝', 'The 月 radical of 朝 kanji means "moon".' ],
            [ '本', 'The 木 radical of 本 kanji means "tree".' ],
            [ '歌', 'The 欠 radical of 歌 kanji means "lack".' ],
            [ '正', 'The 止 radical of 正 kanji means "stop".' ],
            [ '死', 'The 歹 (歺) radical of 死 kanji means "death".' ],
            [ '殺', 'The 殳 radical of 殺 kanji means "weapon".' ],
            [ '毎', 'The 毋 (母) radical of 毎 kanji means "do not".' ],
            [ '毘', 'The 比 radical of 毘 kanji means "compare".' ],
            [ '毬', 'The 毛 radical of 毬 kanji means "fur".' ],
            [ '民', 'The 氏 radical of 民 kanji means "clan".' ],
            [ '気', 'The 气 radical of 気 kanji means "steam".' ],
            [ '活', 'The 水 (氵、氺) radical of 活 kanji means "water".' ],
            [ '点', 'The 火 (灬) radical of 点 kanji means "fire".' ],
            [ '爵', 'The 爪 (爫) radical of 爵 kanji means "claw".' ],
            [ '爺', 'The 父 radical of 爺 kanji means "father".' ],
            [ '爽', 'The 爻 radical of 爽 kanji means "trigrams".' ],
            [ '牀', 'The 爿 (丬) radical of 牀 kanji means "split wood".' ],
            [ '版', 'The 片 radical of 版 kanji means "slice".' ],
            [ '牙', 'The 牙 radical of 牙 kanji means "fang".' ],
            [ '物', 'The 牛 (牜、⺧) radical of 物 kanji means "cow".' ],
            [ '状', 'The 犬 (犭) radical of 状 kanji means "dog".' ],
            [ '率', 'The 玄 radical of 率 kanji means "profound".' ],
            [ '理', 'The 玉 (王、玊) radical of 理 kanji means "jade".' ],
            [ '瓢', 'The 瓜 radical of 瓢 kanji means "melon".' ],
            [ '瓶', 'The 瓦 radical of 瓶 kanji means "tile".' ],
            [ '甚', 'The 甘 radical of 甚 kanji means "sweet".' ],
            [ '産', 'The 生 radical of 産 kanji means "life".' ],
            [ '甫', 'The 用 radical of 甫 kanji means "use".' ],
            [ '男', 'The 田 radical of 男 kanji means "field".' ],
            [ '疑', 'The 疋 (⺪) radical of 疑 kanji means "bolt of cloth".' ],
            [ '病', 'The 疒 radical of 病 kanji means "sickness".' ],
            [ '発', 'The 癶 radical of 発 kanji means "footsteps".' ],
            [ '百', 'The 白 radical of 百 kanji means "white".' ],
            [ '皰', 'The 皮 radical of 皰 kanji means "skin".' ],
            [ '益', 'The 皿 radical of 益 kanji means "dish".' ],
            [ '直', 'The 目 (⺫) radical of 直 kanji means "eye".' ],
            [ '矜', 'The 矛 radical of 矜 kanji means "spear".' ],
            [ '知', 'The 矢 radical of 知 kanji means "arrow".' ],
            [ '研', 'The 石 radical of 研 kanji means "stone".' ],
            [ '社', 'The 示 (礻) radical of 社 kanji means "spirit".' ],
            [ '禽', 'The 禸 radical of 禽 kanji means "track".' ],
            [ '科', 'The 禾 radical of 科 kanji means "grain".' ],
            [ '空', 'The 穴 radical of 空 kanji means "cave".' ],
            [ '章', 'The 立 radical of 章 kanji means "stand".' ],
            [ '算', 'The 竹 (⺮) radical of 算 kanji means "bamboo".' ],
            [ '精', 'The 米 radical of 精 kanji means "rice".' ],
            [ '組', 'The 糸 (糹) radical of 組 kanji means "silk".' ],
            [ '缺', 'The 缶 radical of 缺 kanji means "jar".' ],
            [ '置', 'The 网 (⺲、罓、⺳) radical of 置 kanji means "net".' ],
            [ '美', 'The 羊 (⺶、⺷) radical of 美 kanji means "sheep".' ],
            [ '習', 'The 羽 radical of 習 kanji means "feather".' ],
            [ '考', 'The 老 (耂) radical of 考 kanji means "old".' ],
            [ '耐', 'The 而 radical of 耐 kanji means "and".' ],
            [ '耕', 'The 耒 radical of 耕 kanji means "plough".' ],
            [ '聞', 'The 耳 radical of 聞 kanji means "ear".' ],
            [ '粛', 'The 聿 (⺺、⺻) radical of 粛 kanji means "brush".' ],
            [ '育', 'The 肉 (⺼) radical of 育 kanji means "meat".' ],
            [ '臨', 'The 臣 radical of 臨 kanji means "minister".' ],
            [ '臭', 'The 自 radical of 臭 kanji means "self".' ],
            [ '致', 'The 至 radical of 致 kanji means "arrive".' ],
            [ '興', 'The 臼 radical of 興 kanji means "mortar".' ],
            [ '舘', 'The 舌 radical of 舘 kanji means "tongue".' ],
            [ '舞', 'The 舛 radical of 舞 kanji means "oppose".' ],
            [ '船', 'The 舟 radical of 船 kanji means "boat".' ],
            [ '良', 'The 艮 radical of 良 kanji means "stopping".' ],
            [ '艶', 'The 色 radical of 艶 kanji means "color".' ],
            [ '草', 'The 艸 (⺿) radical of 草 kanji means "grass".' ],
            [ '虚', 'The 虍 radical of 虚 kanji means "tiger".' ],
            [ '蚕', 'The 虫 radical of 蚕 kanji means "insect".' ],
            [ '衆', 'The 血 radical of 衆 kanji means "blood".' ],
            [ '街', 'The 行 radical of 街 kanji means "walk enclosure".' ],
            [ '表', 'The 衣 (⻂) radical of 表 kanji means "clothes".' ],
            [ '要', 'The 襾 (西、覀) radical of 要 kanji means "cover".' ],
            [ '親', 'The 見 radical of 親 kanji means "see".' ],
            [ '解', 'The 角 (⻇) radical of 解 kanji means "horn".' ],
            [ '話', 'The 言 (訁) radical of 話 kanji means "speech".' ],
            [ '谺', 'The 谷 radical of 谺 kanji means "valley".' ],
            [ '豊', 'The 豆 radical of 豊 kanji means "bean".' ],
            [ '象', 'The 豕 radical of 象 kanji means "pig".' ],
            [ '貌', 'The 豸 radical of 貌 kanji means "badger".' ],
            [ '買', 'The 貝 radical of 買 kanji means "shell".' ],
            [ '赦', 'The 赤 radical of 赦 kanji means "red".' ],
            [ '起', 'The 走 radical of 起 kanji means "run".' ],
            [ '路', 'The 足 (⻊) radical of 路 kanji means "foot".' ],
            [ '躯', 'The 身 radical of 躯 kanji means "body".' ],
            [ '転', 'The 車 radical of 転 kanji means "cart".' ],
            [ '辞', 'The 辛 radical of 辞 kanji means "bitter".' ],
            [ '農', 'The 辰 radical of 農 kanji means "morning".' ],
            [ '通', 'The 辵 (⻌、⻍、⻎) radical of 通 kanji means "walk".' ],
            [ '部', 'The 邑 (⻏) radical of 部 kanji means "city".' ],
            [ '配', 'The 酉 radical of 配 kanji means "wine".' ],
            [ '釈', 'The 釆 radical of 釈 kanji means "distinguish".' ],
            [ '野', 'The 里 radical of 野 kanji means "village".' ],
            [ '銀', 'The 金 (釒) radical of 銀 kanji means "gold".' ],
            [ '長', 'The 長 (镸) radical of 長 kanji means "long".' ],
            [ '間', 'The 門 radical of 間 kanji means "gate".' ],
            [ '院', 'The 阜 (⻖) radical of 院 kanji means "mound".' ],
            [ '隷', 'The 隶 radical of 隷 kanji means "slave".' ],
            [ '集', 'The 隹 radical of 集 kanji means "short-tailed bird".' ],
            [ '電', 'The 雨 radical of 電 kanji means "rain".' ],
            [ '静', 'The 靑 (青) radical of 静 kanji means "blue".' ],
            [ '靠', 'The 非 radical of 靠 kanji means "wrong".' ],
            [ '靨', 'The 面 (靣) radical of 靨 kanji means "face".' ],
            [ '靴', 'The 革 radical of 靴 kanji means "leather".' ],
            [ '韓', 'The 韋 radical of 韓 kanji means "tanned leather".' ],
            [ '韮', 'The 韭 radical of 韮 kanji means "leek".' ],
            [ '響', 'The 音 radical of 響 kanji means "sound".' ],
            [ '頭', 'The 頁 radical of 頭 kanji means "leaf".' ],
            [ '颯', 'The 風 radical of 颯 kanji means "wind".' ],
            [ '飜', 'The 飛 radical of 飜 kanji means "fly".' ],
            [ '館', 'The 食 (飠) radical of 館 kanji means "eat".' ],
            [ '馗', 'The 首 radical of 馗 kanji means "head".' ],
            [ '馨', 'The 香 radical of 馨 kanji means "fragrant".' ],
            [ '駅', 'The 馬 radical of 駅 kanji means "horse".' ],
            [ '髄', 'The 骨 radical of 髄 kanji means "bone".' ],
            [ '高', 'The 高 (髙) radical of 高 kanji means "tall".' ],
            [ '髪', 'The 髟 radical of 髪 kanji means "hair".' ],
            [ '鬧', 'The 鬥 radical of 鬧 kanji means "fight".' ],
            [ '鬱', 'The 鬯 radical of 鬱 kanji means "sacrificial wine".' ],
            [ '鬻', 'The 鬲 radical of 鬻 kanji means "cauldron".' ],
            [ '魅', 'The 鬼 radical of 魅 kanji means "ghost".' ],
            [ '鮮', 'The 魚 radical of 鮮 kanji means "fish".' ],
            [ '鳴', 'The 鳥 radical of 鳴 kanji means "bird".' ],
            [ '鹸', 'The 鹵 radical of 鹸 kanji means "salt".' ],
            [ '麗', 'The 鹿 radical of 麗 kanji means "deer".' ],
            [ '麦', 'The 麥 radical of 麦 kanji means "wheat".' ],
            [ '麿', 'The 麻 radical of 麿 kanji means "hemp".' ],
            [ '黄', 'The 黃 radical of 黄 kanji means "yellow".' ],
            [ '黎', 'The 黍 radical of 黎 kanji means "millet".' ],
            [ '黒', 'The 黑 radical of 黒 kanji means "black".' ],
            [ '鼈', 'The 黽 radical of 鼈 kanji means "frog".' ],
            [ '鼎', 'The 鼎 radical of 鼎 kanji means "tripod".' ],
            [ '鼕', 'The 鼓 radical of 鼕 kanji means "drum".' ],
            [ '鼬', 'The 鼠 radical of 鼬 kanji means "rat".' ],
            [ '鼾', 'The 鼻 radical of 鼾 kanji means "nose".' ],
            [ '齋', 'The 齊 (斉) radical of 齋 kanji means "even".' ],
            [ '齢', 'The 齒 radical of 齢 kanji means "tooth".' ],
            [ '龕', 'The 龍 radical of 龕 kanji means "dragon".' ],
            [ '龜', 'The 龜 radical of 龜 kanji means "turtle".' ]
]);
