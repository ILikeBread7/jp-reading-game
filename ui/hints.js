...
const KANJI_EXTRA_TEXT = new Map([
            ...
            ['月', [
                ...
                'The 月 radical of 月 kanji means "moon ".',
            ]],
            ...
            ['凶', 'The 凵 radical of 凶 kanji means "receptacle".'],
            ['分', 'The 刀 (刂、⺈) radical of 分 kanji means "knife".'],
            ['力', 'The 力 radical of 力 kanji means "power".'],
            ...
            ['比', 'The 比 radical of 比 kanji means "compare".'],
            ['毛', 'The 毛 radical of 毛 kanji means "fur".'],
            ['民', 'The 氏 radical of 民 kanji means "clan".'],
            ['気', 'The 气 radical of 気 kanji means "steam".'],
            ['水', 'The 水 (氵、氺) radical of 水 kanji means "water".'],
            ['火', 'The 火 (灬) radical of 火 kanji means "fire".'],
            ['爪', 'The 爪 (爫) radical of 爪 kanji means "claw".'],
            ['父', 'The 父 radical of 父 kanji means "father".'],
            ['爽', 'The 爻 radical of 爽 kanji means "trigrams".'],
            ['爿', 'The 爿 (丬) radical of 爿 kanji means "split wood".'],
            ['版', 'The 片 radical of 版 kanji means "slice".'],
            ['牙', 'The 牙 radical of 牙 kanji means "fang".'],
            ['牛', 'The 牛 (牜、⺧) radical of 牛 kanji means "cow".'],
            ['犬', 'The 犬 (犭) radical of 犬 kanji means "dog".'],
            ['率', 'The 玄 radical of 率 kanji means "profound".'],
            ['王', 'The 玉 (王、玊) radical of 王 kanji means "jade".'],
            ['瓜', 'The 瓜 radical of 瓜 kanji means "melon".'],
            ['瓶', 'The 瓦 radical of 瓶 kanji means "tile".'],
            ['甘', 'The 甘 radical of 甘 kanji means "sweet".'],
            ['生', 'The 生 radical of 生 kanji means "life".'],
            ['用', 'The 用 radical of 用 kanji means "use".'],
            ['田', 'The 田 radical of 田 kanji means "field".'],
            ...
            ['白', 'The 白 radical of 白 kanji means "white".'],
            ['皮', 'The 皮 radical of 皮 kanji means "skin".'],
            ['皿', 'The 皿 radical of 皿 kanji means "dish".'],
            ['目', 'The 目 (⺫) radical of 目 kanji means "eye".'],
            ['矛', 'The 矛 radical of 矛 kanji means "spear".'],
            ['知', 'The 矢 radical of 知 kanji means "arrow".'],
            ['石', 'The 石 radical of 石 kanji means "stone".'],
            ...
            ['立', 'The 立 radical of 立 kanji means "stand".'],
            ['竹', 'The 竹 (⺮) radical of 竹 kanji means "bamboo".'],
            ['米', 'The 米 radical of 米 kanji means "rice".'],
            ['糸', 'The 糸 (糹) radical of 糸 kanji means "silk".'],
            ['缶', 'The 缶 radical of 缶 kanji means "jar".'],
            ['置', 'The 网 (⺲、罓、⺳) radical of 置 kanji means "net".'],
            ['美', 'The 羊 (⺶、⺷) radical of 美 kanji means "sheep".'],
            ['羽', 'The 羽 radical of 羽 kanji means "feather".'],
            ['考', 'The 老 (耂) radical of 考 kanji means "old".'],
            ['耐', 'The 而 radical of 耐 kanji means "and".'],
            ['耕', 'The 耒 radical of 耕 kanji means "plough".'],
            ['耳', 'The 耳 radical of 耳 kanji means "ear".'],
            ['粛', 'The 聿 (⺺、⺻) radical of 粛 kanji means "brush".'],
            ['肉', 'The 肉 (⺼) radical of 肉 kanji means "meat".'],
            ['臣', 'The 臣 radical of 臣 kanji means "minister".'],
            ['自', 'The 自 radical of 自 kanji means "self".'],
            ['至', 'The 至 radical of 至 kanji means "arrive".'],
            ['興', 'The 臼 radical of 興 kanji means "mortar".'],
            ['舌', 'The 舌 radical of 舌 kanji means "tongue".'],
            ['舞', 'The 舛 radical of 舞 kanji means "oppose".'],
            ['船', 'The 舟 radical of 船 kanji means "boat".'],
            ['良', 'The 艮 radical of 良 kanji means "stopping".'],
            ['色', 'The 色 radical of 色 kanji means "color".'],
            ['草', 'The 艸 (⺿) radical of 草 kanji means "grass".'],
            ['虚', 'The 虍 radical of 虚 kanji means "tiger".'],
            ['虫', 'The 虫 radical of 虫 kanji means "insect".'],
            ['血', 'The 血 radical of 血 kanji means "blood".'],
            ...
            ['豆', 'The 豆 radical of 豆 kanji means "bean".'],
            ['象', 'The 豕 radical of 象 kanji means "pig".'],
            ['貌', 'The 豸 radical of 貌 kanji means "badger".'],
            ['貝', 'The 貝 radical of 貝 kanji means "shell".'],
            ['赤', 'The 赤 radical of 赤 kanji means "red".'],
            ['走', 'The 走 radical of 走 kanji means "run".'],
            ['足', 'The 足 (⻊) radical of 足 kanji means "foot".'],
            ['身', 'The 身 radical of 身 kanji means "body".'],
            ['車', 'The 車 radical of 車 kanji means "cart".'],
            ...
            ['金', 'The 金 (釒) radical of 金 kanji means "gold".'],
            ...
            ['雨', 'The 雨 radical of 雨 kanji means "rain".'],
            ['青', 'The 靑 (青) radical of 青 kanji means "blue".'],
            ['非', 'The 非 radical of 非 kanji means "wrong".'],
            ['面', 'The 面 (靣) radical of 面 kanji means "face".'],
            ['革', 'The 革 radical of 革 kanji means "leather".'],
            ['韓', 'The 韋 radical of 韓 kanji means "tanned leather".'],
            ['韮', 'The 韭 radical of 韮 kanji means "leek".'],
            ['音', 'The 音 radical of 音 kanji means "sound".'],
            ['頭', 'The 頁 radical of 頭 kanji means "leaf".'],
            ['風', 'The 風 radical of 風 kanji means "wind".'],
            ['飛', 'The 飛 radical of 飛 kanji means "fly".'],
            ['食', 'The 食 (飠) radical of 食 kanji means "eat".'],
            ['首', 'The 首 radical of 首 kanji means "head".'],
            ['香', 'The 香 radical of 香 kanji means "fragrant".'],
            ['馬', 'The 馬 radical of 馬 kanji means "horse".'],
            ['骨', 'The 骨 radical of 骨 kanji means "bone".'],
            ['高', 'The 高 (髙) radical of 高 kanji means "tall".'],
            ['髪', 'The 髟 radical of 髪 kanji means "hair".'],
            ['鬥', 'The 鬥 radical of 鬥 kanji means "fight".'],
            ...
            ['魚', 'The 魚 radical of 魚 kanji means "fish".'],
            ['鳥', 'The 鳥 radical of 鳥 kanji means "bird".'],
            ['鹸', 'The 鹵 radical of 鹸 kanji means "salt".'],
            ['鹿', 'The 鹿 radical of 鹿 kanji means "deer".'],
            ['麦', 'The 麥 radical of 麦 kanji means "wheat".'],
            ['麻', 'The 麻 radical of 麻 kanji means "hemp".'],
            ['黄', 'The 黃 radical of 黄 kanji means "yellow".'],
            ['黎', 'The 黍 radical of 黎 kanji means "millet".'],
            ['黒', 'The 黑 radical of 黒 kanji means "black".'],
            ['黽', 'The 黽 radical of 黽 kanji means "frog".'],
            ['鼎', 'The 鼎 radical of 鼎 kanji means "tripod".'],
            ['鼓', 'The 鼓 radical of 鼓 kanji means "drum".'],
            ['鼠', 'The 鼠 radical of 鼠 kanji means "rat".'],
            ['鼻', 'The 鼻 radical of 鼻 kanji means "nose".'],
            ['齊', 'The 齊 (斉) radical of 齊 kanji means "even".'],
            ['齢', 'The 齒 radical of 齢 kanji means "tooth".'],
            ['龍', 'The 龍 radical of 龍 kanji means "dragon".'],
